...
import 'package:gatator/app/controllers/quizpreferences_controller.dart';
...
class QuizPageController extends GetxController {
  ...
  QuizPreferencesController quizPreferencesController = Get.find();
  ...
  Future<void> onInit() async {
    try {
      isLoading(true);
      questions.value = quizPreferencesController.questions;
